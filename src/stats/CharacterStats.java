...
{
    Character(10, 5, 2, 3, 2, 1, 2, 1, "" , 0, 0, 0, "Level 1", 0,0);
    public int cHP = 0;
    public int cMP = 0;
    ...
    CharacterStats(int Hp, int Mp, int damage, int mDamage, int Speed, int mSpeed, int intelligence, int spellcost, String name , int magicRest, int meleeRest , int currentXp, String currentLevel, int upgradePoint, int money)
    {
        cHP = Hp;
        cMP = Mp;
        cDamage = damage;
